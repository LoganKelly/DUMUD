...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "goto",           do_goto,        POS_DEAD,       L2,  LOG_NORMAL, 1 },
...
/*  { "channels",	do_channels,	POS_DEAD,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "namecolor",	do_namecolor,	POS_DEAD,	 0,  LOG_ALWAYS, 1 ),
...
/*  { "auction",	do_auction,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "gocial",		do_gocial,	POS_SLEEPING,	 0,  LOG_NORMAL, 0 },
...
/*  { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "allow",		do_allow,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    { "ban",		do_ban,		POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    { "deny",		do_deny,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
    { "disconnect",	do_disconnect,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    { "flag",		do_flag,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    ...
    { "set",		do_set,		POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    { "shutdow",	do_shutdow,	POS_DEAD,	L1,  LOG_NORMAL, 0 },
    { "shutdown",	do_shutdown,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
/*  { "sockets",	do_sockets,	POS_DEAD,	L2,  LOG_NORMAL, 1 }, */
    { "wizlock",	do_wizlock,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },

    { "force",		do_force,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
    { "load",		do_load,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
    ...
    { "pecho",		do_pecho,	POS_DEAD,	L1,  LOG_ALWAYS, 1 }, 
    { "pardon",		do_pardon,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
    { "purge",		do_purge,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
...
/*  { "goto",		do_goto,	POS_DEAD,	L2,  LOG_NORMAL, 1 }, */
    ...
    { "peace",		do_peace,	POS_DEAD,	L1,  LOG_NORMAL, 1 },
    { "echo",		do_recho,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
    ...
    { "vnum",		do_vnum,	POS_DEAD,	L1,  LOG_NORMAL, 1 },
    { "zecho",		do_zecho,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
